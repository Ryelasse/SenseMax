...
namespace SenseMax.Tests
{
    ...
    public class ArtworkTests
    {
        ...
        {
            // arrange
            correctInstance = new Artwork("Magnificent Chef", 27.5, 50, 25, 30, 45, 60, 2, "");
            wrongInstance = new Artwork("Magnificent Chefs", 34, 64, 25, 30, 45, 60, 1, "");
            nearInstanceUpper = new Artwork("Magnificent Chefu", 29.99, 59.99, 25, 30, 45, 60, 3, "");
            nearInstanceLower = new Artwork("Magnificent Chefu", 25.01, 45.01, 25, 30, 45, 60, 5, "");
        }
